...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="grid size-9 place-items-center rounded-full border border-charcoal-200 bg-white text-charcoal-600 transition hover:border-primary-300 hover:text-primary-600 dark:border-charcoal-700 dark:bg-charcoal-800 dark:text-charcoal-300 dark:hover:border-primary-500 dark:hover:text-primary-400"
    >
      {isDark ? (
